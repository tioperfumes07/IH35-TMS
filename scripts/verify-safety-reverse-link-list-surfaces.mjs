...
const CHECKS = [
  ...
  { name: "Internal fines driver/liability drills", file: "apps/frontend/src/pages/safety/InternalFinesPage.tsx", pattern: /kind="driver"[\s\S]{0,120}id=\{row\.driver_id as string \| undefined\}[\s\S]{0,2500}kind="liability" id=\{String\(row\.driver_liability_id\)\}/ },

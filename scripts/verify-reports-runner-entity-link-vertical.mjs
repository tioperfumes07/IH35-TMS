...
function failures(configSource = config, tableSource = table) {
...
if (process.argv.includes("--selftest")) {
  ...
  console.log(`verify-reports-runner-entity-link-vertical SELFTEST PASS — ${caught + 1}/${exactLinks.length + 1} planted defects rejected`);
  process.exit(0);
}

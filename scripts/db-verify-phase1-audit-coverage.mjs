...
const EVENT_CLASSES = [
  ...
  "accounting.driver_charge.created",
  "accounting.vendor_chargeback.created",
  "accounting.customer_adjustment.created",
  "accounting.manual_invoice.created",
  "dispatch.book_load.ocr_completed",
  "documents.attachment.downloaded",
  "documents.attachment.upload_url_issued",

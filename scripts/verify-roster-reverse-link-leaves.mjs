...
function audit(s) {
  ...
  if (!/<EntityLink kind=\{kind\} id=\{row\.entity_id\} label=\{row\.display_name\}/.test(s.names) || !/navigate\(row\.link_to_module_page\)/.test(s.names)) failures.push("names canonical entity drills missing");

 ...
 *
 *   node scripts/verify-listcustomers-combobox-without-referenceselect.mjs
 *   node scripts/verify-listcustomers-combobox-without-referenceselect.mjs --selftest
 */
...
const LABEL = "verify-listcustomers-combobox-without-referenceselect";

#!/usr/bin/env node
/**
 * verify-inventory-entitylink-unresolved-tombstone.mjs
 * LV-INVENTORY-ENTITYLINK-UNRESOLVED-TOMBSTONE
 *
 * Inventory Assignments / Purchases must not pass entityLabel(...) straight into
 * EntityLink (dead drill for "— not visible"). Use EntityLinkOrTombstone.
 */
import fs from "node:fs";
import path from "node:path";
import process from "node:process";

const LABEL = "verify-inventory-entitylink-unresolved-tombstone";
...
const CONSUMERS = [
  ...
  "apps/frontend/src/pages/inventory/InventoryPurchasesPage.tsx",
];

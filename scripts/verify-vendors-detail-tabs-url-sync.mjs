#!/usr/bin/env node
/**
 * verify-vendors-detail-tabs-url-sync.mjs — Ops F: Vendors detail tabs use ?tab=.
 */
...
const LABEL = "verify-vendors-detail-tabs-url-sync";
...
function run() {
  ...
  if (source.includes('useState<VendorTabId>("transaction_list")')) {

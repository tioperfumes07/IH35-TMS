...
const child = spawn(process.execPath, ["dist/index.js"], {
  ...
  env: {
    ...
    ENABLE_QBO_CDC_POLL: "false",
    ENABLE_QBO_INBOUND_SYNC: "false",
    ENABLE_QBO_SYNC_RUN_WORKER: "false",
    ENABLE_QBO_OUTBOX_DISPATCHER: "false",
    ENABLE_QBO_TOKEN_REFRESH_CRON: "false",
    ENABLE_QBO_FORENSIC_RUNNER: "false",

...
const KNOWN_PHANTOM_DEBT = [
  ...
  { rel: "mdata.load_stop_legs", why: "[HOLD-FOR-JORGE] forward-ref — DSP-48 Google reference-miles-per-leg table, routed to CC-1 for migration authorship 2026-09-05 (docs/bus/INBOX-CC-1.md, CC-2 cannot author migrations); every write in google-reference-miles.service.ts is try/catch degrade-safe on a relation-absent error, same discipline as tasks.task_link above. Remove from debt when CC-1's migration merges." },

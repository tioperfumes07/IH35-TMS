#!/usr/bin/env node
/** @matrix-built {"modules":["legal","drivers"],"cols":["driver","connectivity","reverse_link","picker_law"],"leafRe":"^matters\\.(list|create|detail)$|^profiles\\.detail$","task":"THEATER-LEGAL-MATTER-DRIVER-LEAFRE","vertical":"column-wave"} */

#!/usr/bin/env node
/**
 * verify-program-tracker-tabs-url-sync.mjs — Ops F: Program Tracker tabs use ?tab=.
 */
...
const LABEL = "verify-program-tracker-tabs-url-sync";

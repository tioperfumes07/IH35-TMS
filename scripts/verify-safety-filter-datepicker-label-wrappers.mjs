...
function inspect() {
  ...
  for (const rel of FILES) {
    ...
    if (labels.some((label) => label.includes("<DatePicker"))) errors.push(`${rel}: filter DatePicker remains label-wrapped`);

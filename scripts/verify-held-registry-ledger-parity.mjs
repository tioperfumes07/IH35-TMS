...
export const EXPECTED_HELD = [
  // EMPTY as of 2026-07-25 registry truth-up. Zero genuinely-unapplied held migrations remain.
  // 202608070000_escrow_forfeit_posting_type_sign_and_flag_seed.sql left this list the way the charter
  // allows: GUARD re-proved it APPLIED on prod — present in BOTH _system._schema_migrations and
  // ih35_migrations.applied_migrations, live-verified 2026-07-25 — so it moved to applied_held.
  // The demo purge 202608060000 is deliberately NOT here: its file lives on the #3530 branch and is
  // NOT applied (correctly absent from prod). When that PR lands it must be re-listed here.
];

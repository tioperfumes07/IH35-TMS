...
const LABEL="verify-user-detail-driver-entity-picker"; const FILE="apps/frontend/src/pages/UserDetail.tsx";
...
if(process.argv.includes("--selftest")){
  ...
  const stubRoot=fs.mkdtempSync(path.join(ROOT,".tmp-user-detail-driver-entity-picker-"));

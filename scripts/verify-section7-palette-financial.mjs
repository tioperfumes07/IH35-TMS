...
const BASELINE = 68; // set by PALETTE_BASELINE_PRINT (2026-07-20, 0441-mod8 driver-finance/factoring/cash-advances/notices batch) — grandfathered; ratchet only downward

...
const CHECKS = [
  ...
  { name: "register distinguishes categorization and matched load labels", file: VIEW, pattern: /tx\.categorization_load_id \? tx\.categorization_load_number : tx\.matched_load_number/ },

...
const CHECKS = [
  ...
  ["apps/backend/src/work-orders/work-orders.routes.ts", /wo_search_driver_dca\.driver_id = d\.id[\s\S]{0,180}wo_search_driver_dca\.company_id = w\.operating_company_id[\s\S]{0,180}wo_search_driver_dca\.is_authorized = true[\s\S]{0,180}wo_search_driver_dca\.deactivated_at IS NULL/],
  ["apps/backend/src/work-orders/work-orders.routes.ts", /wo_pdf_driver_dca\.driver_id = d\.id[\s\S]{0,180}wo_pdf_driver_dca\.company_id = \$2::uuid[\s\S]{0,180}wo_pdf_driver_dca\.is_authorized = true[\s\S]{0,180}wo_pdf_driver_dca\.deactivated_at IS NULL/],

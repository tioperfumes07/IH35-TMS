...
const CHECKS = [
  ...
  ["apps/frontend/src/pages/maintenance/components/SevereRepairOosTab.tsx", /useSearchParams\(\)\[0\]\.get\("unit_id"\)/],
  ...
  ["apps/frontend/src/pages/maintenance/FaultDraftsPage.tsx", /getUnit\(String\(deepLinkUnitId\), companyId\)/],
  ["apps/frontend/src/pages/maintenance/FaultDraftsPage.tsx", /entityLabel\(deepLinkUnitQuery\.data\?\.unit_number, deepLinkUnitId, "Unit"\)/],
  ...
  ["apps/frontend/src/components/maintenance/WorkOrderDetailModal.tsx", /kind="unit" id=\{String\(workOrder\.unit_id\)\}/],

/**
 * verify-no-hold-language-in-active-blocks — ADOPTED by CC-1 from CC-3 (ACCT-F158).
 *
 ...
 *
 * 2773 % 4 === 1, so this number is CC-1's to claim.
 */
export default {
  ...
  async run(ctx) {
    ...
    return ctx.run("node", ["scripts/verify-no-hold-language-in-active-blocks.mjs"]);
  },
};

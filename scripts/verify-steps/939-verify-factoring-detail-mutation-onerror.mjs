...
const commands = [
  ["node", ["scripts/verify-factoring-detail-mutation-onerror.mjs", "--selftest"], null],
  ["node", ["scripts/verify-factoring-detail-mutation-onerror.mjs"], null],
];
...
const step = {
  name: "939-verify-factoring-detail-mutation-onerror",
  run: runFactoringDetailMutationOnerrorStep,
};
...
async function selftest() {
  ...
  console.log("939 verify-step --selftest PASS — guard selftest + live scan executed, planted failure propagated");
}

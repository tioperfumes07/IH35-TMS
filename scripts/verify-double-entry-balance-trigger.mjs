...
try {
  ...
  // trial balance reads). The old guard only forbade CREATEing the table; the banking manual-JE route INSERTed
  // into it and was NOT caught, so a JE booked there never moved the books. This scans the backend source too.

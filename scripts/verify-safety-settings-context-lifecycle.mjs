...
function selftest() {
  ...
  if (missed.length) {
    console.error(`verify-safety-settings-context-lifecycle SELFTEST FAIL — ${missed.length}/3 mutation(s) survived`);
    process.exit(1);
  }
  console.log("verify-safety-settings-context-lifecycle selftest PASS — 3/3 planted defects rejected");
}

...
const CHECKS = [
  ...
  ["apps/backend/src/dispatch/pod.routes.ts", /FROM mdata\.driver_company_authorizations pod_capture_driver_dca[\s\S]{0,180}pod_capture_driver_dca\.driver_id = dd\.id[\s\S]{0,140}pod_capture_driver_dca\.company_id = l\.operating_company_id[\s\S]{0,140}pod_capture_driver_dca\.is_authorized = true[\s\S]{0,140}pod_capture_driver_dca\.deactivated_at IS NULL/],
  ...
  ["apps/backend/src/notifications/dispatcher.ts", /FROM mdata\.driver_company_authorizations abandoned_load_driver_dca[\s\S]{0,180}abandoned_load_driver_dca\.driver_id = d\.id[\s\S]{0,180}abandoned_load_driver_dca\.company_id = l\.operating_company_id[\s\S]{0,180}abandoned_load_driver_dca\.is_authorized = true[\s\S]{0,180}abandoned_load_driver_dca\.deactivated_at IS NULL/],

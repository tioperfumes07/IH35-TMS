...
const SELF = path.join(ROOT, "scripts/verify-cash-flow-statement-print-letter.mjs");
...
function assertSource() {
  if (!fs.existsSync(PAGE)) fail("missing CashFlowStatementPage");
  ...
  if (!page.includes("printLetterHtml")) fail("CashFlowStatementPage must use printLetterHtml");

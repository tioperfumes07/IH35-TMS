#!/usr/bin/env node
/**
 * verify-qbo-vendor-linkage-tabs-url-sync.mjs — Ops F: QBO Vendor Linkage tabs use ?tab=.
 */
...
const LABEL = "verify-qbo-vendor-linkage-tabs-url-sync";

...
const SELF = path.join(ROOT, "scripts/verify-balance-sheet-print-letter.mjs");
...
function assertSource() {
  ...
  if (!page.includes("printLetterHtml")) fail("BalanceSheetPage must use printLetterHtml");

#!/usr/bin/env node
/**
 * verify-financial-statements-tabs-url-sync.mjs — Ops F: Financial Statements tabs use ?tab=.
 */
...
const LABEL = "verify-financial-statements-tabs-url-sync";

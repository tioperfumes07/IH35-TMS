...
function check(sources) {
  ...
  const expects = [
    ...
    ["arriving", /<EntityLink kind="load" id=\{card\.load_id\}/, "arriving-soon load"],
    ["transit", /<EntityLink kind="unit" id=\{issue\.unit_id\}/, "in-transit unit"],
...
if (process.argv.includes("--self-test")) {
  const mutations = [
    ...
    ["kanban", 'kind="load"', 'kind="customer"'],
    ["roundTrips", 'kind="load"', 'kind="customer"'],
    ["arriving", 'kind="unit"', 'kind="vendor"'],
    ["arriving", 'kind="load"', 'kind="customer"'],
    ["transit", 'kind="unit"', 'kind="vendor"'],

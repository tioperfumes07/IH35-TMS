#!/usr/bin/env node
/**
 * verify-docs-entity-tabs-url-sync.mjs — Ops F: Docs entity tabs use ?tab=.
 */
...
const LABEL = "verify-docs-entity-tabs-url-sync";
...
function run() {
  ...
  if (source.includes('useState<FileEntityType | "all">("all")') || source.includes('useState<DocsEntityTabId>("all")')) {

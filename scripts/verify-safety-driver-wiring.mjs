...
const CHECKS = [
  ...
  ["apps/backend/src/routes/safety/hos-violations.ts", /hos_violations_list_dca\.driver_id = d\.id[\s\S]{0,180}hos_violations_list_dca\.company_id = hv\.operating_company_id[\s\S]{0,180}hos_violations_list_dca\.is_authorized = true[\s\S]{0,180}hos_violations_list_dca\.deactivated_at IS NULL/],
  ...
  ["apps/backend/src/routes/safety/dot-inspections.ts", /dot_inspections_list_dca\.driver_id = d\.id[\s\S]{0,180}dot_inspections_list_dca\.company_id = di\.operating_company_id[\s\S]{0,180}dot_inspections_list_dca\.is_authorized = true[\s\S]{0,180}dot_inspections_list_dca\.deactivated_at IS NULL/],
  ...
  ["apps/backend/src/routes/safety/complaints.ts", /complaint_create_complainant_dca\.driver_id = d\.id[\s\S]{0,180}complaint_create_complainant_dca\.company_id = \$1::uuid[\s\S]{0,180}complaint_create_complainant_dca\.is_authorized = true[\s\S]{0,180}complaint_create_complainant_dca\.deactivated_at IS NULL/],
  ["apps/backend/src/routes/safety/complaints.ts", /complaint_create_respondent_dca\.driver_id = d\.id[\s\S]{0,180}complaint_create_respondent_dca\.company_id = \$1::uuid[\s\S]{0,180}complaint_create_respondent_dca\.is_authorized = true[\s\S]{0,180}complaint_create_respondent_dca\.deactivated_at IS NULL/],
  ...
  ["apps/backend/src/safety/events/safety-events.routes.ts", /safety_event_create_driver_dca\.driver_id = d\.id[\s\S]{0,180}safety_event_create_driver_dca\.company_id = \$1::uuid[\s\S]{0,180}safety_event_create_driver_dca\.is_authorized = true[\s\S]{0,180}safety_event_create_driver_dca\.deactivated_at IS NULL/],
  ...
  ["apps/backend/src/safety/training-records.routes.ts", /training_create_driver_dca\.driver_id = d\.id[\s\S]{0,180}training_create_driver_dca\.company_id = \$2::uuid[\s\S]{0,180}training_create_driver_dca\.is_authorized = true[\s\S]{0,180}training_create_driver_dca\.deactivated_at IS NULL/],
  ["apps/backend/src/safety/medical-cards.routes.ts", /medical_card_create_driver_dca\.driver_id = d\.id[\s\S]{0,180}medical_card_create_driver_dca\.company_id = \$2::uuid[\s\S]{0,180}medical_card_create_driver_dca\.is_authorized = true[\s\S]{0,180}medical_card_create_driver_dca\.deactivated_at IS NULL/],
  ["apps/backend/src/safety/background-checks.routes.ts", /background_check_create_driver_dca\.driver_id = d\.id[\s\S]{0,180}background_check_create_driver_dca\.company_id = \$2::uuid[\s\S]{0,180}background_check_create_driver_dca\.is_authorized = true[\s\S]{0,180}background_check_create_driver_dca\.deactivated_at IS NULL/],
  ["apps/backend/src/safety/driver-qualification.routes.ts", /qualification_create_driver_dca\.driver_id = d\.id[\s\S]{0,180}qualification_create_driver_dca\.company_id = \$2::uuid[\s\S]{0,180}qualification_create_driver_dca\.is_authorized = true[\s\S]{0,180}qualification_create_driver_dca\.deactivated_at IS NULL/],
  ...
  ["apps/backend/src/safety/driver-scoring/scoring.service.ts", /scoring_events_dca\.driver_id = d\.id[\s\S]{0,180}scoring_events_dca\.company_id = e\.operating_company_id[\s\S]{0,180}scoring_events_dca\.is_authorized = true[\s\S]{0,180}scoring_events_dca\.deactivated_at IS NULL/],
  ["apps/backend/src/safety/driver-scoring/scoring.service.ts", /scoring_miles_dca\.driver_id = d\.id[\s\S]{0,180}scoring_miles_dca\.company_id = a\.operating_company_id[\s\S]{0,180}scoring_miles_dca\.is_authorized = true[\s\S]{0,180}scoring_miles_dca\.deactivated_at IS NULL/],
  ["apps/backend/src/safety/driver-scoring/scoring.service.ts", /scoring_active_dca\.driver_id = d\.id[\s\S]{0,180}scoring_active_dca\.company_id = \$1::uuid[\s\S]{0,180}scoring_active_dca\.is_authorized = true[\s\S]{0,180}scoring_active_dca\.deactivated_at IS NULL/],

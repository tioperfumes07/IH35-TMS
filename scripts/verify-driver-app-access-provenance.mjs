...
function failuresFor(source) {
  const checks = [
    ...
    ["lost driver link aborts access provisioning", /driver\.identity_user_id !== identityUserId && !linkRes\.rows\[0\][\s\S]{0,100}driver_app_access_state_changed/.test(source)],

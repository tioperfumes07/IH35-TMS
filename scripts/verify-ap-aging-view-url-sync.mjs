#!/usr/bin/env node
/**
 * verify-ap-aging-view-url-sync.mjs — Ops F: A/P Aging view uses ?view=.
 */
...
const LABEL = "verify-ap-aging-view-url-sync";
...
function run() {
  ...
  if (source.includes('useState<"by_vendor" | "by_type">("by_vendor")')) {

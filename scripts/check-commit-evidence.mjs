 ...
 *
 * Money paths ALSO run assertNoMoneyTheater (DoD §10 / verify-step 1430) — FINDING + DOD-A..E +
 * VERIFY-1..5 required or the commit is rejected.
 *
...
`);
  if (isMoneyAppCommit(files)) {
    console.error(`
MONEY PATH (accounting / banking / qbo-sync) — also required (DoD §10 / Rule 23):

...
const PATH_MODULE = [
  [/pages\/dispatch|components\/dispatch|border-crossing|LoadReassign|CancelLoad|PreDispatch|BookLoad/i, "dispatch"],
  ...
  [/pages\/accounting|components\/ap\/|PaymentApply|CustomerAdjustment|ExpenseCreate|BillPayment|VendorBill|PrepaidExpense|RecurringBill|NewAccountDrawer|NewClassDrawer|NewServiceDrawer/i, "accounting"],
  [/pages\/banking|MatchDrawer|CategorizeDrawer|ReconMatch/i, "banking"],
  [/pages\/maintenance|RoadService|TriageModal|components\/maintenance/i, "maintenance"],
  ...
  [/pages\/lists|CatalogExcel|ItemEditor|AccountingCatalogProfile|InlineCreate|CatalogQuickCreate|NewCustomerDrawer|NewVendorDrawer/i, "lists"],
  [/pages\/drivers|components\/drivers|OnboardingWizard|SendMessage|SuspendConfirm|TerminateConfirm/i, "drivers"],
  [/pages\/customers/i, "customers"],
  [/pages\/vendors/i, "vendors"],
  [/pages\/insurance|components\/insurance|PolicyCreate|ClaimCreate/i, "insurance"],
  [/pages\/fuel/i, "fuel"],
  [/pages\/fleet|components\/fleet|EquipmentTransfer/i, "fleet"],
  ...
  [/pages\/tasks/i, "tasks"],
  [/pages\/system|integrations\/edi|EdiSetup/i, "system"],
  [/pages\/users/i, "users"],
  [/pages\/help|pages\/onboarding\//i, "help"],
  [/pages\/home|pages\/Home/i, "home"],
  [/form_425|425c|Form425/i, "form_425"],
  [/driver-hub|DriverHub/i, "driver-hub"],
];

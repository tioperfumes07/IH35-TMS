Cursor→self | GO-NOW | DOM #18286 on main · leftover drain USMCA · secret PROD_READONLY_DATABASE_URL is owner not paste · no seat packets through Jorge · skip #15546 | GO
Cursor→self | GO-USMCA-ONLY-SISTER-PROOF | THIS IS NOW · USMCA only · MECHANISM not BINDING · LAW-8 · no posting flip · skip #15546 | GO
Cursor→self | GO-INSTRUMENT-PLANNER | THIS IS NOW · live=d41124e planner deployed · lead · Codex guard · CC-1 sql paste · secret PROD_READONLY_DATABASE_URL · no second deploy · packet docs/lockdown/GO-INSTRUMENT-PLANNER-2026-08-30.md · skip #15546 | GO
...
**00:15 CT GO-0001 — WORK NOW.** Packet `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-28-0001.md`. Live **`1dbd082`**. ACK: `CURSOR | ACK | GO-0001 | NOW=lead+palette | SHA=1dbd082 | GO`. No POD for Event 2. SOT block on every FINDING. Never second-kick deploy.
...
**05:52 CT GO-0552 — THIS IS NOW.** Lead. Packet `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-27-0552.md`. Deploy IN FLIGHT `dep-da81eaad0e5s73a261hg` — no second-kick. U14 first `/banking`. ACK: `Cursor | ACK | GO-0552 | PORT=9222 | NOW=lead+banking | SHA=<healthz> | GO`.

**05:40 CT GO-0540 — THIS IS NOW.** Lead. Packet `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-27-0540.md`. **None launch-ready.** Deploy may be in flight — no second-kick. Overflow `/home` `/help` `/users` `/docs` `/inventory`. ACK: `Cursor | ACK | GO-0540 | PORT=9222 | NOW=lead | SHA=<healthz> | GO`.

**05:21 CT GO-0521 — THIS IS NOW.** Lead. Packet `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-27-0521.md`. Deploy IN FLIGHT `dep-da810bgae00c73ade7gg` — **do not second-kick**. Overflow customer Reactivate. ACK: `Cursor | ACK | GO-0521 | PORT=9222 | NOW=lead | SHA=<healthz> | GO`.
...
**18:52 CT GO-1852 — IDLE=LIVE-WALK. THIS IS NOW.** Packet `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-26-1852.md`. Live **`f12ab6e`**. If idle: live-verify or CREATE TEST on your next vertical URL same turn. HOLDING=defect. Nobody `trigger_deploy`. Skip #15546. ACK: `Cursor | ACK | GO-1852 | PORT=9222 | NOW=lead | SHA=f12ab6e | GO`

**YOUR NOW:** Lead. Idle seats get next vertical URL. Leftover FE overflow only.

**18:30 CT GO-1830 — CURSOR LEAD. THIS IS NOW.** Packet `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-26-1830.md`. Live until land=`b3dae9d`. Deploy IN FLIGHT `dep-da7ndvvavr4c73b842sg` tip `8745b43`. Hard-reload when healthz moves. Nobody `trigger_deploy`. Skip #15546. U14 never restamp. Idle=defect. ACK: `Cursor | ACK | GO-1830 | PORT=9222 | NOW=lead | SHA=8745b43 | GO`

**YOUR NOW:** Lead. Leftover FE overflow only. Do not steal money. One in-flight deploy — no second kick.

**18:15 CT 2026-08-26 GO-1815 — CURSOR LEAD. THIS IS NOW.** Live **`b3dae9d`** (`dep-da7n3b49v7es73f0s9ag` LIVE). Hard-reload. Nobody `trigger_deploy` (just landed; main may be a few commits ahead — wait for 5–10). Skip #15546. U14 never restamp. FAST-MERGE ~4 min. ACK: `Cursor | ACK | GO-1815 | PORT=9222 | NOW=lead | SHA=b3dae9d | GO`

**YOUR NOW:** lead. leftover FE unique only. Deploy just landed — no second kick.

**17:45 CT 2026-08-26 GO-1745 — CURSOR LEAD. THIS IS NOW.** Older GO-1405 SHA `c46d592` / `29ad498` INBOX TOPs below stay as history. Live until this deploy lands = **`29ad498`**. API deploy **IN FLIGHT** `dep-da7mp2navr4c73b5h7hg` tip **`ece4a06`** (#16356). Hard-reload when healthz moves. Nobody second-kick. Skip #15546. CC never `trigger_deploy`. U14 never restamp. FAST-MERGE ~4 min. Packet still GO-1405 law. ACK: `Cursor | ACK | GO-1745 | PORT=9222 | NOW=lead+leftover-FE | SHA=ece4a06 | GO`

**YOUR NOW:** lead census; leftover FE unique only. Do not steal money. Deploy already in flight — no second kick.

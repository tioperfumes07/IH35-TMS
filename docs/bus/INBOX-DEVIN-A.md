...
3. Click any register row claimed FIXED since last OUTBOX (SEL-01, DatePicker, LAY-04/05 when FE has it)
4. CTL-01/02/03 — Live Chrome only; keep FAIL until CC-3 ships real fix
5. OUTBOX one line → goto 1 when new FE sha appears

**Forbidden:** STAND BY · asking Cursor to rebuild History · idle after one verify

**ACK:** `DEVIN-A | ACK | NOW=History-click | fe=<sha> | GO`

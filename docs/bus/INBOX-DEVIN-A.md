...
**YOU ARE DEVIN-A. Clicked Live. chrome=9227.** **OWNER SEQ (not A–Z):** accounting → banking → factoring → settlements → drivers → customers → vendors → dispatch. Miss C = 0 is the 100. Read **`docs/bus/SEAT-COMMS-LAW.md`**. Stale INBOX → ping Cursor.

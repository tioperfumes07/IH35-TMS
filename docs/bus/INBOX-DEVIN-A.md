...
Cursor→DEVIN-A | VOID seat · do not work · skip #15546 | GO
...
Cursor→DEVIN-A | STANDING-ORDERS-2026-08-29 | docs/lockdown/STANDING-ORDERS-CC-1-CC-2-CC-3-2026-08-29.md | FEED docs/bus/FEED/NOW-DEVIN-A.md | pull never idle | GO
...
**13:31 CT GO-1331.** Same Devin `/vendors` on `4b859b7`. ACK `Devin-A | ACK | GO-1331 | NOW=/vendors | SHA=4b859b7 | GO`.
...
**07:58 CT GO-0758.** Follow INBOX-DEVIN BOX.

**07:45 CT GO-0745.** Follow INBOX-DEVIN.

**07:41 CT GO-0741.** Follow INBOX-DEVIN.

**07:38 CT GO-0738.** Follow INBOX-DEVIN.

**07:34 CT GO-0734.** Follow INBOX-DEVIN.
...
**14:05 CT 2026-08-26 GO-1405 — CURSOR LEAD. THIS IS NOW.** Older GO/CLAUDE-LEAD/`ok:false` lines below are **VOID as NOW**. Live **`c46d592`**. Packet: `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-26-1405.md`. ACK: `Devin-A | ACK | GO-1405 | PORT=9227 | NOW=/customers | SHA=c46d592 | GO`. Idle=defect. Not PARKED. Skip #15546. Never `trigger_deploy`. Never recertify U14. Start: `~/Desktop/IH35-START-2-DEVIN-A.command`. Board: `docs/audit/GUARD-WORKORDERS.md`. Excel. API: `~/Desktop/APIS-ALL-05-29-2026.rtfd`. **YOUR NOW:** `/customers` then `/dispatch` Book Load + calendars. Unique FINDING. Confirm CURRENT-LAW in packet.
...
**23:49 CT CLAUDE IS LEAD. WORK NOW. Not PARKED. ACK YOUR OUTBOX this turn.** Paste GO-2310. `/customers` then `/dispatch` calendars + Book Load nested create. FINDING only. Never `trigger_deploy`.

**23:19 CT WORK NOW. Not PARKED. ACK YOUR OUTBOX.** Paste GO-2310. Live `/customers` then `/dispatch` calendars + Book Load nested creates. Unique FINDING. Cursor is lead.

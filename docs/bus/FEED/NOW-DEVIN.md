...
Query-back **Override toast** on live FE `451b359`. G1 squash is on **origin/main** (`3a1591d8`) but live API is still `069d531` — do not stamp aging/sample FIXED on live until healthz moves. Do not idle waiting for deploy.

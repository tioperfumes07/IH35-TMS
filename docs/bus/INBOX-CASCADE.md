Cursor→Cascade | GO-CASCADE-FALSE-POSITIVE-GREP | THIS IS NOW · STOP filing isError Miss-C · B then A never C · re-audit 50277-50344 per-file single-term grep (no pipe) · SUPERSEDE only proven false · KEEP 50309 if still no isError · packet docs/lockdown/GO-CASCADE-FALSE-POSITIVE-GREP-2026-08-30.md · skip #15546 · never trigger_deploy | GO

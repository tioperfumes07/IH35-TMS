...
5. **Seats:** Cursor = lead + fleet/maint Built + safety board OPEN. Codex = reverse FO (no CDP). **Devin-A = Clicked 9227 AUTO — never pause for continue.** CC-1 = money/GL + `CLS-MONEY-ROLE-COVERAGE-SWEEP`. CC-2 = lists pickers. CC-3/Cascade = OFF.
6. **Urgent 16 (A–Z):** accounting, banking, cash-flow, customers, dispatch, drivers, factoring, finance, fleet, insurance, legal, lists, maintenance, safety, settlements, vendors.

# ARCHIVED OUTBOX — CASCADE
**Source:** `docs/bus/OUTBOX-CASCADE.md` · **Cut date:** 2026-08-31
**Law:** `docs/lockdown/BUS-DIET-LAW-COST-CONTROL-2026-08-31.md` Rule 1
**Reader law:** NO SEAT ever loads `docs/bus/archive/`. WORM preserved; out of read path.

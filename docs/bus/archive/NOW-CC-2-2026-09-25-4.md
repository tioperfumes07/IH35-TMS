...
Live-verified: 656 -> 335 violations (321 exempted = 134 factoring_advance + 101 driver_settlement
+ 86 factoring_default_interest, by source_transaction_type only). wrong_credit_account_1090
unchanged at 117 (invariant 2 untouched, confirmed). Stale "Cursor fixes the WRITER" text replaced
in both the guard file and money-pr-local-gate.mjs. 11 journal_entry JEs reviewed one by one (all
settlement tie-out residuals, $180.00 total, all correctly stay hand-written, not exempted) — full
table in the PR body. Selftest 12/12 PASS. Remaining 335 (207 fuel_event + 11 journal_entry +
117 wrong_credit) is your writer fix; this branch does not claim the guard green.

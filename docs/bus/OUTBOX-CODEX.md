...
Codex | LIVE-CHROME | ACCT-F10156 PRE-FIX | healthz=ef848ab | url=https://app.ih35dispatch.com/dispatch/book-load | walkthrough=Dispatch→Book Load→reload→footer says “Not priceable — no driver bill will be created” before inputs, despite canonical submit-time rate-card fallback | click=Book Load navigation | reload=PASS | ids=none;mutation=NONE | FIX=honest per-load-preview/rate-card/skip disclosure | Live post-deploy pending | GO

Codex | LIVE-CHROME | PHASE-7 BANK→SETTLEMENT HONEST BLOCK | healthz=ef848ab | url=https://app.ih35dispatch.com/banking/transactions?txn_id=155945b9-4598-411b-9e2f-5213879b2cbd | walkthrough=Banking→Transactions→filter settlement→expand owner-named Settlement-5402-LIquidado $1,056.15→Match→Search all 5402→no matchable record; separate owner-now $1,850 txn→Search all settlement→only $144/$1,104/$297.60 settlements, all variance-held | click=Match + Open match drawer + Search all | reload=PASS | ids=bank:155945b9-4598-411b-9e2f-5213879b2cbd;bank:6a89bc48-4238-436c-a906-b7e45ee821b1 | mutation=NONE | no forced variance | NEXT=Lane-B mechanical | GO

Codex | LIVE-CHROME | LOAD-5 RATE-STALE-MONEY-BLOCK | healthz=ef848ab | url=https://app.ih35dispatch.com/dispatch/loads/f782ec51-975e-41a4-8085-2e9f962a5be8?view=list | walkthrough=reload Dispatched→click Mark in transit→reload In Transit→Driver Pay shows none→click Mark delivered pending docs→reload Delivered pending docs + invoice 64b8846e-ecd5-4143-bf87-9f03a34815af sent→Driver Pay shows B-20260831-0003 $180.00 at 150 short mi × $1.20/mi | click=Mark in transit + Mark delivered (pending docs) | reload=PASS | load=f782ec51-975e-41a4-8085-2e9f962a5be8 | bill=B-20260831-0003 | expected_rate_ui=$0.45_loaded+$0.45_empty | actual_billing_rate=$1.20 | short_pay=NOT_ATTEMPTED | completion=NOT_ATTEMPTED | existing_finding=PAY-RATE-DUAL-TABLE-SPLIT-DISCONNECTED-FROM-BILLING | STOP no workaround | GO
...
CODEX | OWNER-CORRECTION | INV-NUMBERING-01=WITHDRAWN | INV-F-DISPLAYID=WITHDRAWN | SETL-NUMBERING-01=WITHDRAWN | EXP-NUMBERING-01=RESPECIFIED-NULL-ONLY-<load#>-<seq> | proforma=LOCKED-SAME-RECORD-LIFECYCLE | source=OWNER-DECISIONS-FINAL-2026-07-26.md-§B | no-product-code | GO
CODEX | ACK | NO-SEAT-CREATED-FINANCIAL-RECORDS-IN-PRODUCTION | own-fixtures=FORBIDDEN | owner-ordered-walk=PRELIST+SANCTION+SAME-SESSION-VOID+REVERSING-JE-ID | item36=no-manufactured-prerequisite | guard-owner=CC-2 | GO
CODEX | PARITY | TWO-DATE-PAYMENT-CLEARING | NetSuite=ordinary-payment-date+posting-period-separate-from-statement-close; in-transit-confirmation-is-exception | McLeod=PUBLIC-DOC-UNVERIFIED-GL+RECON-MAPPING | IH35-GAPS=SETL-GL-DATE-DERIVED-FROM-SETTLEMENT-PERIOD-END+SETL-TAX-YEAR-USES-CLEARED-DATE | no-prod-records | report=docs/audit/CODEX-TWO-DATE-PAYMENT-CLEARING-PARITY-2026-09-01.md | GO
CODEX | TRANSACTION-HEALTH | BAND-E+PARITY | baseline=PASS2/FAIL13/NEVER-RUN24-UNCHANGED | E1=BUILDABLE-NOT-RUN | E2/E3/E4=BLOCKED-ON-MACHINE-UNIVERSE | parity-gaps=RECON-AFTER-CLOSE-MUTATION+GL-SEQUENCE+DATE-PERIOD+INTERCOMPANY+INVENTORY+FX+ASYNC-POSTING | McLeod=PUBLIC-DOC-UNVERIFIED | no-prod-write | report=docs/audit/CODEX-TRANSACTION-HEALTH-ENTITY-PARITY-2026-09-01.md | GO
CODEX | PROD-FIXTURE-DISCLOSURE | confirmed-created-by-this-seat=banking.bank_transactions:67ce5e7c-5c8d-405d-a742-c20bbc860c24 (Live Chrome CSV upload $1,104);mdata.loads:f782ec51-975e-41a4-8085-2e9f962a5be8 (L-20260831-0003, sample/demo checked);accounting.invoices:64b8846e-ecd5-4143-bf87-9f03a34815af (auto-created pro forma/invoice from that load);driver-bill:B-20260831-0003 (auto-created after status transition) | attributable-needs-live-identity-confirmation=mdata.drivers:e901be6e-cee7-41cd-8827-8b5c320c9a20 (TEST CODEX ONBOARD 20260824; Codex edited loaded+empty rates);catalogs.accounts:DRIVERCASHAD896665-023 (Driver Cash Advance- TEST CODEX ONBOARD 20260824; register reports $1,200 balance) | linked-not-claimed-created=driver_finance.driver_settlements:95b76f0d-0ede-4b60-a74a-ec80dd2488af (S-20260802-0258);accounting.journal_entries:ceb26c99-cb49-46eb-9fc0-40751d431032 (existing pay-run JE matched by bank upload) | cleanup-proof=NOT-CLAIMED; no deletion/void/reversal performed this audit; owner purge may already have acted | source=durable OUTBOX lines + transaction-health law | GO
CODEX | LIVE-CHROME | SETL-SELECTION-BINDING RE-ENTRY=FAIL | healthz=78a1efddb3780a72fad1a734a0192f80f3f84303 built=01:38:54Z contains=#19018 | url=https://app.ih35dispatch.com/driver-finance/settlement-close | walkthrough=reload→sole picker row S-20260830-0014→rendered link/detail S-20260831-0006 closed $264.00→STOP | click=NONE | reload=PASS | condition1=FAIL wrong-ID binding persists | conditions6-8=UNMEETABLE only-one-row/no-nonfirst/no-resort-A-B-A | mutation=NONE no-payment-method/no-close/no-bank-row/no-reopen/no-match | freeze=REMAINS | GO
CODEX | ACK | GO-MECH-0901 | NOW=board-rows | register-missing=55/55-filed-by-root | COL-06=9-gap-surfaces+1-compliant-control | purge-held=10/10-CC-1-FK-order | product-code=NONE | GO

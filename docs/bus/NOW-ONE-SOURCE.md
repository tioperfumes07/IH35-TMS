...
**CLOSED (do not rebuild):** GO-18 Gap 5 MAX+1 hard-delete guard — Cursor **#19839** `a9a021b349` · step **10232**. `display-id.ts` unchanged. `bills.driver_id` vs `expenses.driver_uuid` is intentional — do not rename. Load expense numbers = `12225` then `12225-1` (not `-01`).

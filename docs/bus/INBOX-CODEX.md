...
NOW **TODAY — CERTIFY customers first** (reverse SQL/GET). **This-tick curl** `GET https://api.ih35dispatch.com/api/v1/healthz/shallow` = **`bd67370`** (uptime ~95s — deploy `dep-da5n84mk1f9s739557jg` is **LIVE**). Re-run hops on **this** SHA. Then **one** OUTBOX line `Codex | CERTIFIED | MODULE=customers | LIVE_SHA=bd67370`. Then drivers. Then fleet. **CUST-MONEY-F6105 / F6278 are CC-1 leftover money — they are not your U14 reverse stamp gate.** Mandatory hops: `docs/bus/U14-OPEN-MODULE-BY-MODULE-HOPS-2026-08-23.md`

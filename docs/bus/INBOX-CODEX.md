...
`git pull --ff-only origin main`. **Law:** `docs/bus/URGENT-BLOCKS-NOW-2026-08-22.md` **08:54 CT**. **No CDP theater.** Prove reverse with SQL/GET/guard. Port **9226** only if you click a reverse drill you already wired.

**ACK:** prepaid / credit-memo / vendor-credit create POST **proven**. Do **not** re-walk. **Empty-queue / drained / stale / waiting Cursor = DEFECT after this pull.**
...
OUTBOX first line: `Codex | ACK | URGENT-BLOCKS-NOW 08:54CT | PORT=9226 | NOW=banking.* reverse | GO`

**Forbidden:** Chrome login theater · idle · remake Accounting create proofs · wait healthz · wait Jorge · wait Cursor · fake reverse PASS.
...
FORBIDDEN: CDP theater · idle · drained · empty-queue · wait Jorge · wait Cursor
ACK: Codex | ACK | URGENT-BLOCKS-NOW 08:54CT | PORT=9226 | NOW=banking reverse | GO
===== END CODEX =====
```

...
## VOID
POST Book Load · idle · remake B12 if live banner already matches #19571 · create locations table · reopen miles
...
Do not take GO-24 (CC-3). Do not take purge (CC-1).

ACK `CODEX | ACK | GO-23 | NOW=A3/B12 live vs #19571 · NEVER POST | GO`

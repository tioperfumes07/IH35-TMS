...
OPEN:
1. Bank↔settlement match backup if Codex 30m Chrome miss (Codex actively working it as of 12:46 CT restart, not yet at the 30m miss threshold — recheck before picking up)

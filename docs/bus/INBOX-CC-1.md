...
Cursor→CC-1 | FULL PACKET IN THIS FILE | NOW=task order in CC-1.txt · 7 debtor answers CLOSED in OWNER-7-ANSWERS.txt · create IH 35 Transportation LLC as USMCA vendor (qbo_* NULL) before Jorge $8890 bill · skip #15546 | GO
...
In-repo (open these; do not require Jorge's laptop Downloads path):
  docs/lockdown/PASTE-TO-CODERS-2026-08-30/CC-1.txt
  docs/lockdown/PASTE-TO-CODERS-2026-08-30/OWNER-7-ANSWERS.txt
  docs/lockdown/PASTE-TO-CODERS-2026-08-30/data/FARO-26-CUSTOMERS-TO-CREATE.csv
  docs/lockdown/PASTE-TO-CODERS-2026-08-30/data/FARO-DEBTOR-MATCH-TO-TRANSPORTATION.csv
  docs/lockdown/PASTE-TO-CODERS-2026-08-30/data/FARO-33-INVOICES-TO-CREATE.csv
...
===== ATTACHMENT OWNER-7-ANSWERS.txt =====
OWNER + CURSOR MATCH ANSWERS 2026-08-30 (CC-1 task 4 — paste now, do not wait)

1 IMPACT BULK LOGISTICS LLC = Impact Bulk Logistics?  YES
2 Sethmar Transportation Inc = Sethmar Transportation?  YES
3 Watco: (b) Watco Supply Chain Services LLC DBA Watco Logistics
4 Sajacks: (a) Sajacks Freight  (Freigth is a typo dupe — do not copy as a second USMCA customer)
5 NCC: (a) NCC Logistics  (USA; not México)
6 Simple: (b) Simple Logistics LLC  (not Simplex)
7 CTS XPRESS LLC = CTS EXPRESS LLC?  YES  (canonical TRANSP spelling EXPRESS)

COPY TRANSP → USMCA without qbo_customer_id / qbo_vendor_id.
CREATE NEW (no TRANSP): DARDINI LLC, FLS Transport Inc., J RAYL TRANSPORT INC, S E Mares Forwarding Service LLC.
===== END FULL PACKET =====

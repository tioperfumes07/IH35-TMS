...
1. Open `docs/audit/GUARD-WORKORDERS.md` — top **OPEN money** row in CC-1 lane (not UNVERIFIED-deploy escrow/vendor-404). Fix + guard + FAST-MERGE.
2. If none: browser **9223** → `https://app.ih35dispatch.com/banking` on **USMCA**. One labeled TEST money hop that is **not** already proven (memo `TEST DATA VOID-AT-LAUNCH`). **Do not** Match/Categorize remaining For-review.
3. Then `https://app.ih35dispatch.com/driver-finance/settlements` — settlement close / deduction / pay-run money leftover. One TEST if unproven.
...
```text
===== CC-1 · PORT 9223 · FAST-MERGE · BANKING MONEY =====

CASCADE | FINDING | 50217 | system · T-08-CT — Central Time rendering inventory: 329 toLocale* without timeZone, 15 hardcoded "America/Chicago" literals, 2 local TZ dups | GO — Cursor lane (guard + consolidation)

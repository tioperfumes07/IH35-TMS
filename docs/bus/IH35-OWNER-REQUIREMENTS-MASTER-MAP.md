...
| 1.6 | Void reason = DROPDOWN CATALOG, optional memo. No free typing | CURSOR | **QUEUED** — `catalogs.void_reasons` |
...
| # | Requirement | Owner | Status |
|---|---|---|---|
| 9.1 | Deactivate trucks not active; leave only insured units | CURSOR | **DROPPED** ⚠ — assigned twice, never reported |

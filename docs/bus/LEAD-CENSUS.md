# LEAD CENSUS — GO-23 · 2026-09-02 06:26 CT

**Queue:** `claude/GO-23-BUILD-SEQUENCE-STRICT-2026-09-02.md`.

Seats **never POST Book Load.** Tip `095ef73d` (C6 `--strict` **2**, **#19631** exemption). API `dep-dac0chqjnfac73ehob2g` **live** — do not stack.

| Seat | NOW | Must not |
|------|-----|----------|
| **CC-3** | **WAIT** (A1 #19609/#19612) | Wave 3 GO-22; Wave 4 C1 |
| **CC-1** | **C6 2 remaining** — lumper first · TONU HOLD | skip to B8; remake #19631 |

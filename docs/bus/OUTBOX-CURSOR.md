...
Cursor-docs | RESOLVED | 2026-08-24T09:10CT | PR #15371 + #15372 merged clean. PR #15373 rebase hit a real conflict in this bus file only (docs.routes.ts auto-merged cleanly - the type-filter fix and preview-category fix touch different lines) - union-resolved (kept both sides' history), retrying merge | GO

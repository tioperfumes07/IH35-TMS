...
|------|--------|------------|
| **Devin-A** | 12 Live Chrome | WAVE 1 banking Clicked → rest WAVE 1 → WAVE 2 → WAVE 3. **Clicked ships OUTBOX-only onto current origin/main** (never stale-branch squash that reverts CC-1/CC-3). |

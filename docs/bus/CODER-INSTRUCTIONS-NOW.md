# CODER INSTRUCTIONS NOW · 2026-08-21 18:56 CT
...
7. **Categorize / Match / recon is not a coder function.** Coders ship honest labels, wiring, pickers, F+R. Do not treat For-review counts as a work queue.

| Seat | File | NOW |
|------|------|-----|
| **CC-1** | `INBOX-CC-1.md` | **Honest labels + wiring.** `ACCT-REGISTER-REF-IS-SOURCE-UUID` then expense_number tombstones. Categorize is not this seat’s job. Worker OFF. |

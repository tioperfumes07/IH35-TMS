...
ADDITIVE-ONLY: never delete/remove/reorder modules, pages, sidebar, sections, cards, KPIs, fields, columns, tabs, routes. ARCHIVE never DELETE. Sidebar locked 22 items. "+ Create"/"+ Book" vocabulary. No new financial code — call existing accounting/factoring/settlement service functions only.

...
|------|------|---------|------|
| Cursor | 9222 | Lead **unless** `docs/bus/LEAD-SEAT.md` is `CC-1` | GO-0027 wake-all. Census. Skip #15546 #16895. Deploy already kicked. |
| CC-1 | 9223 | money | GO-0027 **NOW=BANK-TRANSFER dual-writer then /accounting**. Never `trigger_deploy`. |
| CC-2 | 9224 | leftover POST | GO-0027 **NOW=/home then /fuel unique**. Never idle. |
| CC-3 | 9225 | FE | GO-0027 **NOW=banking USMCA then /eld**. BANK-CTRL-01 not a flag hunt. |
| Codex | 9226 | FE | GO-0027 **NOW=dispatch unique leftover**. Never restamp U14 |
| Cascade | audit | unique FINDING | GO-0027 live healthz. Skip #15546 #16895 |
| Devin-A | audit | unique FINDING | GO-0027 `/customers` then `/driver-hub`. Vendors = DEVIN paste |

...
|------|------|---------|----------------------------|
| Cursor | 9222 | vendors | `/vendors` leftover unique 500/dead/silent Fully-Wired **1–12**. Dispatch **omit** (CERTIFIED LIVE_SHA=39472f2). Banking **omit** (CERTIFIED LIVE_SHA=36e51bb). Then maint → safety → insurance |

# GO-0082 — Sidebar unique sweep E (425c→docs)

`git pull --ff-only origin main`
Queue index: `docs/lockdown/GO-QUEUE-0055-0104-INDEX.md`
THIS packet: `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-28-0082.md`
...
**NOW = this GO.** After FAST-MERGE/ACK, immediately start **GO-0083** without waiting for Jorge or Cursor chat. Idle=defect.
...
ACK: `SEAT | ACK | GO-0082 | NOW=<one line> | SHA=<healthz> | GO`

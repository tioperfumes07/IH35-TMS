# GO-0076 — Full money sweep A (acct→settlements) + GUARD sample + Banking chrome

`git pull --ff-only origin main`
Queue index: `docs/lockdown/GO-QUEUE-0055-0104-INDEX.md`
THIS packet: `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-28-0076.md`
...
**NOW = this GO.** After FAST-MERGE/ACK, immediately start **GO-0077** without waiting for Jorge or Cursor chat. Idle=defect.
...
### Cascade
Cascade money surfaces FINDING

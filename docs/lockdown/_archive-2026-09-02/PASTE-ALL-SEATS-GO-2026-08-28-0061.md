# GO-0061 — Invoice leftover + GUARD lists + Legal TEST

`git pull --ff-only origin main`
Queue index: `docs/lockdown/GO-QUEUE-0055-0104-INDEX.md`
THIS packet: `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-28-0061.md`
...
**NOW = this GO.** After FAST-MERGE/ACK, immediately start **GO-0062** without waiting for Jorge or Cursor chat. Idle=defect.
...
ACK: `SEAT | ACK | GO-0061 | NOW=<one line> | SHA=<healthz> | GO`

## Per coder (do this, this GO)

### CC-1 (9223)
CC-1 invoice leftover unique

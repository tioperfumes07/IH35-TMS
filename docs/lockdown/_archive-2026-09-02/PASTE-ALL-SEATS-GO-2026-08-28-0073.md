# GO-0073 — Customer money leftover + GUARD customers + Maintenance pass

`git pull --ff-only origin main`
Queue index: `docs/lockdown/GO-QUEUE-0055-0104-INDEX.md`
THIS packet: `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-28-0073.md`
...
**NOW = this GO.** After FAST-MERGE/ACK, immediately start **GO-0074** without waiting for Jorge or Cursor chat. Idle=defect.

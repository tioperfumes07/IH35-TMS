# GO-0055 — TXH honesty + SYS-S07 REOPEN + money next-work-item

`git pull --ff-only origin main`
Queue index: `docs/lockdown/GO-QUEUE-0055-0104-INDEX.md`
THIS packet: `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-28-0055.md`
...
**NOW = this GO.** After FAST-MERGE/ACK, immediately start **GO-0056** without waiting for Jorge or Cursor chat. Idle=defect.
...
ACK: `SEAT | ACK | GO-0055 | NOW=<one line> | SHA=<healthz> | GO`

## Per coder (do this, this GO)

### CC-1 (9223)
CC-1 next-work-item accounting/banking/vendors
`CLOSES: none — money hop; prod_verified only after CC-2 GUARD live prove`

### CC-2 (9224) — GUARD
CC-2 REOPEN SYS-S07 + prove TXH known-bad FAIL on live
`CLOSES: none — GUARD live-prove; flip prod_verified only after live click+Neon on current SHA`

### CC-3 (9225)
CC-3 Live Chrome unique Safety stuck-tab class

...
CONFLICT 1 — Capitalize threshold ($7,000 vs $2,500 vs no-threshold)
  ...
  CPA / owner side:
    docs/lockdown/OWNER-DECISIONS-FINAL-2026-07-26.md:29 — "A4-D6 $7,000"
    GO-12 L143 — "Capitalize-vs-expense threshold = $7,000"

  GO-12 / skill side ($2,500):
    GO-12 L144 — "$2,500 or more capitalizes to Fixed Asset - Trucks"
  ...
  Code side (implements $7,000 auto-pick):
...
CONFLICT 2 — Depreciation register (build now vs defer)
  ...
  CPA / owner side:
    ...
    GO-12 L152–153 — "BUILD THE FULL fixed-asset + auto-depreciation register NOW"

  Locked spec side (defer / JE-only):
    GO-12 L154 — "depreciation register JE-only now (FLT-01/08 later)"
...
CONFLICT 3 — Revenue — CLOSED (owner 2026-09-01)
    GO-12 L157–162 — pickup = pro forma, delivery = invoice
    No finding filed. Do not rebuild.

CONFLICT 4 — Accessorials CoA parent (Line Haul vs Sales of Service)

  CPA ANSWERS side:
    GO-12 L165–167 — "accessorials will be SUB ACCOUNTS OF LINE HAUL"

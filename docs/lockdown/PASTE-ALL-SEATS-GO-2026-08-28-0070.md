# GO-0070 — Settlements leftover pass2 + GUARD fuel + System TXH

`git pull --ff-only origin main`
Queue index: `docs/lockdown/GO-QUEUE-0055-0104-INDEX.md`
THIS packet: `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-28-0070.md`
...
**NOW = this GO.** After FAST-MERGE/ACK, immediately start **GO-0071** without waiting for Jorge or Cursor chat. Idle=defect.
...
ACK: `SEAT | ACK | GO-0070 | NOW=<one line> | SHA=<healthz> | GO`

## Per coder (do this, this GO)

### CC-1 (9223)
CC-1 settlements leftover
...
### CC-3 (9225)
CC-3 /system TXH filters USMCA-only walk

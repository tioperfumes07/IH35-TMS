# GO-0083 — Sidebar unique sweep F (help→system)

`git pull --ff-only origin main`
Queue index: `docs/lockdown/GO-QUEUE-0055-0104-INDEX.md`
THIS packet: `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-28-0083.md`
...
**NOW = this GO.** After FAST-MERGE/ACK, immediately start **GO-0084** without waiting for Jorge or Cursor chat. Idle=defect.
...
ACK: `SEAT | ACK | GO-0083 | NOW=<one line> | SHA=<healthz> | GO`

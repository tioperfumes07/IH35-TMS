# GO-0084 — CREATE-TEST wave accounting+dispatch+vendors

`git pull --ff-only origin main`
Queue index: `docs/lockdown/GO-QUEUE-0055-0104-INDEX.md`
THIS packet: `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-28-0084.md`
...
**NOW = this GO.** After FAST-MERGE/ACK, immediately start **GO-0085** without waiting for Jorge or Cursor chat. Idle=defect.
...
ACK: `SEAT | ACK | GO-0084 | NOW=<one line> | SHA=<healthz> | GO`

## Per coder (do this, this GO)

### CC-1 (9223)
CC-1 TEST expense/bill
`CLOSES: none — money hop; prod_verified only after CC-2 GUARD live prove`

### CC-2 (9224) — GUARD
CC-2 GUARD prove one PASS→prod_verified if live

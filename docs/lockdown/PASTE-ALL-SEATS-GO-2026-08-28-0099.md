# GO-0099 — 500 / dead-click sweep POST leftover

`git pull --ff-only origin main`
Queue index: `docs/lockdown/GO-QUEUE-0055-0104-INDEX.md`
THIS packet: `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-28-0099.md`
...
**NOW = this GO.** After FAST-MERGE/ACK, immediately start **GO-0100** without waiting for Jorge or Cursor chat. Idle=defect.
...
ACK: `SEAT | ACK | GO-0099 | NOW=<one line> | SHA=<healthz> | GO`

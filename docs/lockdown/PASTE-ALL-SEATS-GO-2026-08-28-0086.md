# GO-0086 — CREATE-TEST wave insurance+maintenance+fleet

`git pull --ff-only origin main`
Queue index: `docs/lockdown/GO-QUEUE-0055-0104-INDEX.md`
THIS packet: `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-28-0086.md`
...
**NOW = this GO.** After FAST-MERGE/ACK, immediately start **GO-0087** without waiting for Jorge or Cursor chat. Idle=defect.
...
ACK: `SEAT | ACK | GO-0086 | NOW=<one line> | SHA=<healthz> | GO`

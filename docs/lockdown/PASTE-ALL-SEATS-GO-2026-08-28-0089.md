# GO-0089 — Deep linkage F+R banking↔expenses

`git pull --ff-only origin main`
Queue index: `docs/lockdown/GO-QUEUE-0055-0104-INDEX.md`
THIS packet: `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-28-0089.md`
...
**NOW = this GO.** After FAST-MERGE/ACK, immediately start **GO-0090** without waiting for Jorge or Cursor chat. Idle=defect.
...
ACK: `SEAT | ACK | GO-0089 | NOW=<one line> | SHA=<healthz> | GO`

## Per coder (do this, this GO)

### CC-1 (9223)
CC-1 banking↔expense F+R
...
### Codex (9226)
Codex fuel↔load going-forward only

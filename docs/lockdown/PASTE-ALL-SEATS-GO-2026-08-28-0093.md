# GO-0093 — Deep linkage F+R safety↔insurance↔legal

`git pull --ff-only origin main`
Queue index: `docs/lockdown/GO-QUEUE-0055-0104-INDEX.md`
THIS packet: `docs/lockdown/PASTE-ALL-SEATS-GO-2026-08-28-0093.md`
...
**NOW = this GO.** After FAST-MERGE/ACK, immediately start **GO-0094** without waiting for Jorge or Cursor chat. Idle=defect.
...
ACK: `SEAT | ACK | GO-0093 | NOW=<one line> | SHA=<healthz> | GO`
...
### CC-3 (9225)
CC-3 safety/insurance/legal chrome

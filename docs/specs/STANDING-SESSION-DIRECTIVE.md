...
## 8. WIRE-FIRST SPRINT (owner-locked 2026-08-12)

**Canonical:** `docs/lockdown/WIRE-FIRST-SPRINT-LAW-2026-08-12.md`

- **10 priority modules:** lists · accounting · dispatch · settlements · factoring · banking · customers · vendors · drivers · safety (USMCA).
- **Wire until 3 boxes green** on every Required cell on those boards (Box 1 Required · Box 2 Audited · Box 3 Built). **Box 4 Live = test phase only after that gate.**
- **Four seats only:** Cursor · Codex · CC-1 · CC-2. **No CC-3.**
- **No Chrome / system test until the gate.** Then full test pass (Box 4 Live).
- **Paste boxes (sole authority — replaces all prior paste):** `docs/specs/CODER-PASTE-INSTRUCTIONS-2026-08-12.md` — four boxes only

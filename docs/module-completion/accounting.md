...
| `ACCT-SURF-01` | **UNVERIFIED** | Bills family — DoD A–E + VERIFY 1–8 on live surfaces | Desktop accounting-surf-dod-2026-07-25.md: structural DOD-A/VERIFY-1 PASS; wizard/picker/reverse density UNVERIFIED. Guard verify-acct-surfaces-structural. | — |
...
| `ACCT-SURF-03` | **UNVERIFIED** | Bill payment — DoD A–E + VERIFY 1–8 with live rows | bill_payments=6479; Desktop SURF DoD UNVERIFIED — TRANSP+USMCA click-through not re-run. Structural route+PayBill ParityDrawer PASS (verify-accounting-money-creator-matrix). | — |

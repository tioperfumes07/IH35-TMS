...
**PROGRESS: 0 of 6** · complete: `false` · as_of: 2026-08-02 · live_sha: `—`
...
| `SYS-S05` | **OPEN** | QuickBooks Sync panel documents write-back OFF by design | scaffold — auditor PASS: matches architecture | — |

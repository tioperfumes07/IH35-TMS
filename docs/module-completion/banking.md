...
**PROGRESS: 4 of 13** · complete: `false` · as_of: 2026-07-25T16:50:00.000Z · live_sha: `b4c3158`
...
| 3 | `BANK-F03` | P0 | banking.reconciliation_sessions = 0; no reconcile flow; RLS root cause | banking.reconciliation_sessions | `BANK-ECON-04`:UNVERIFIED · `BANK-SURF-04`:UNVERIFIED | BANK-ECON-04/BANK-SURF-04 |
...
| `BANK-ECON-03` | **FAIL** | banking.transfers rows > 0 when operators record transfers OR honest empty with poster path proven | KEEP FAIL 2026-07-25: transfers=0 true empty (lucia). Owner: projection/transfer economics stay OFF / reconcile-only. Do not flip flags. Schema refresh tonight does not create transfer density. | #3445 |
| `BANK-ECON-04` | **UNVERIFIED** | reconciliation_sessions > 0 with zero-diff closure (#3417) | SCHEMA-LIVE 2026-07-25: banking.bank_accounts policy bank_accounts_company_scope now includes app.bypass_rls='lucia' escape (mig 202608030000 applied+ledgered; lucia policy using_expr verified). reconciliation_sessions still 0 — needs ops start-session + browser. NOT PASS. Unblocks path; does not prove sessions. | HOLD — see hold/bank-econ-04-recon-session-live-path-20260725 (companion to #3417) |
...
| `BANK-SURF-04` | **UNVERIFIED** | Reconciliation workspace — live session + zero-diff | SCHEMA-LIVE 2026-07-25 (BANK-ECON-04 RLS bypass). Workspace path unblocked at schema; sessions=0 until ops. Rule 23: NOT PASS without authenticated TRANSP+USMCA click-through. No new SURF structural guards. | HOLD — see hold/bank-econ-04-recon-session-live-path-20260725 (companion to #3417) |
...
| `BANK-LINK-01` | **UNVERIFIED** | Bank txn ↔ Bill/Payment/Transfer EntityLink both-way with Neon FKs | SCHEMA-LIVE 2026-07-25: mig 202608050000 applied+ledgered; same-entity FKs bank_tx_categorization_vendor_same_entity_fkey / _customer_same_entity_fkey present (lucia). Needs counterparty density + authenticated both-way browser drill TRANSP+USMCA before PASS (Rule 23). | HOLD — see hold/bank-link-01-counterparty-fk-20260725 (companion to #3459/#3464/step 1441) |

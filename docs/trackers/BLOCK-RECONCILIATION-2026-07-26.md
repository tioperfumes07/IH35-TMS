# BLOCK RECONCILIATION — 2026-07-26 (every block, built vs pending — verified)
...
## Universe — why 1213 blocks (the "456 vs 294 .block-ready" gap, explained)
...
- **By source (after de-dup):** .block-ready: 1025 · program: 77 · enterprise-29: 29 · accounting: 25 · gap-spec: 57

...
## Universe — why 1467 blocks (the "456 vs 294 .block-ready" gap, explained)
...
- **`.block-ready/*.json` files on disk:** 1356 (of which **63 retired** dup/stale/superseded are excluded → **1293 active**)
- **By source (after de-dup):** .block-ready: 1293 · program: 61 · enterprise-29: 29 · accounting: 27 · gap-spec: 57
...
| pre-push-env-isolation | NEEDS-VERIFY | 💰 |  | #1173 | .block-ready | PR #1173 title-match only, unverified |

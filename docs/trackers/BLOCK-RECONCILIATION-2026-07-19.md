# BLOCK RECONCILIATION — 2026-07-19 (every block, built vs pending — verified)
...
## Universe — why 1459 blocks (the "456 vs 294 .block-ready" gap, explained)
...
- **`.block-ready/*.json` files on disk:** 1353 (of which **68 retired** dup/stale/superseded are excluded → **1285 active**)
- **By source (after de-dup):** .block-ready: 1285 · program: 61 · enterprise-29: 29 · accounting: 27 · gap-spec: 57

...
## Universe — why 1473 blocks (the "456 vs 294 .block-ready" gap, explained)
...
- **`.block-ready/*.json` files on disk:** 1363 (of which **63 retired** dup/stale/superseded are excluded → **1300 active**)
- **By source (after de-dup):** .block-ready: 1299 · program: 61 · enterprise-29: 29 · accounting: 27 · gap-spec: 57

# BLOCK RECONCILIATION — 2026-07-25 (every block, built vs pending — verified)
...
## Universe — why 1192 blocks (the "456 vs 294 .block-ready" gap, explained)
...
- **`.block-ready/*.json` files on disk:** 1373 (of which **348 retired** dup/stale/superseded are excluded → **1025 active**)
- **By source (after de-dup):** .block-ready: 1020 · program: 61 · enterprise-29: 29 · accounting: 25 · gap-spec: 57
...
| f-01-fuel-home-stub | NEEDS-VERIFY | 💰 |  | #3467 | .block-ready | PR #3467 title-match only, unverified |

# BLOCK RECONCILIATION — 2026-07-27 (every block, built vs pending — verified)
...
## Universe — why 1222 blocks (the "456 vs 294 .block-ready" gap, explained)
...
- **`.block-ready/*.json` files on disk:** 1378 (of which **348 retired** dup/stale/superseded are excluded → **1030 active**)
- **By source (after de-dup):** .block-ready: 1025 · program: 86 · enterprise-29: 29 · accounting: 25 · gap-spec: 57
...
| BLOCKS-NEW-DECISIONS | PENDING |  |  |  | program | forward spec — 0 named artifacts on main |
| C1-PICKER-LAW-replace-every-raw-UUID-input-with-the-canonica | PENDING |  |  |  | program | forward spec — 0 named artifacts on main |
...
| FOR-CURSOR-2-README-ACCOUNTING-BANKING | PENDING |  |  |  | program | forward spec — 0 named artifacts on main |
| PASTE-TO-CLAUDE-CODER | PENDING |  |  |  | program | forward spec — 0 named artifacts on main |
| PASTE-TO-CURSOR | PENDING |  |  |  | program | forward spec — 0 named artifacts on main |
...
| C11-SPLIT-BRAIN-single-canonical-table-per-entity-STOP-class | NEEDS-VERIFY |  |  | #3576 | program | PR #3576 title-match only, unverified |
...
| f-01-fuel-home-stub | NEEDS-VERIFY | 💰 |  | #3498 | .block-ready | PR #3498 title-match only, unverified |
| f-02-jump-to-tab-nonstandard | NEEDS-VERIFY | 💰 |  | #3513 | .block-ready | PR #3513 title-match only, unverified |
...
| h-05-home-kpi-no-date-range-toggle | NEEDS-VERIFY | 💰 |  | #3116 | .block-ready | PR #3116 title-match only, unverified |

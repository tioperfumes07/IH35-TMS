...
| 788 | Accounting | TBD | fix(accounting): COA-UNCATEGORIZED-EXPENSE-QBO-RECONCILE — point uncategorized_expense role at QBO #25; soft-retire redundant #6999 seed |  | PR-OPEN (STOP, Jorge merges) | 2026-06-15 |  | FINANCIAL Tier 2; idempotent fail-safe reconcile + recurrence guard; GUARD prod-query is the correctness gate post-deploy |

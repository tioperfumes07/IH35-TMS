...
---
*Reconciled 2026-06-16 CDT (v30). 888 task rows (875 + 9 follow-up backlog opened 2026-06-15 + 4 go-live findings/holds opened 2026-06-16: 886 2F-deferred, 887 2H-held, 888 2J-held, 889 Block-6-plan); full merged-PR record auto-pulled from GitHub into tabs 02/03 at export time. Tab 05 Functional Audit is hand-curated (v26) and does NOT refresh on export. Per-sheet detail in the [xlsx export](exports/).*
...
| 1 | A | A3-2 GL — FALLBACK paired JE at POST (Dr expense / Cr QBO-149) + post-time ledger | Asset draw-down so books reconcile; verify-first proved option-a (bill rewire) not clean | HIGH | M | #930 | 🟢 BUILT — PR __GLPR__ · recovery applied at POST (ledger + paired JE atomic); recovery=0→no JE; flag OFF until A3-3 |

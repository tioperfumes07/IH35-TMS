...
---
*Reconciled 2026-06-15 CDT (v28). 884 task rows (875 + 9 follow-up backlog opened 2026-06-15); full merged-PR record auto-pulled from GitHub into tabs 02/03 at export time. Tab 05 Functional Audit is hand-curated (v26) and does NOT refresh on export. Per-sheet detail in the [xlsx export](exports/).*
...
| 7 | `0441-mod8-tx-fields-captured-not-sent` | **COVERED / BUILT-AND-HOLD** | Real gap already shipped as [#3124](https://github.com/tioperfumes07/IH35-TMS/pull/3124) (held mig `202607690000`, categorize persist + guard 1211, CI green, `JORGE-APPROVED`). Not a new DESIGN HOLD — Claude Neon-apply + merge. Wave-3 earlier mis-labeled this before the banking GAP lane closed. | #3124 (do not duplicate) |

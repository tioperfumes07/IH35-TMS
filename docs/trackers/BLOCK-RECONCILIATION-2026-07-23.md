# BLOCK RECONCILIATION — 2026-07-23 (every block, built vs pending — verified)
...
## Universe — why 1191 blocks (the "456 vs 294 .block-ready" gap, explained)
...
- **`.block-ready/*.json` files on disk:** 1372 (of which **348 retired** dup/stale/superseded are excluded → **1024 active**)
- **By source (after de-dup):** .block-ready: 1019 · program: 61 · enterprise-29: 29 · accounting: 25 · gap-spec: 57
...
| f-01-fuel-home-stub | NEEDS-VERIFY | 💰 |  | #2829 | .block-ready | PR #2829 title-match only, unverified |

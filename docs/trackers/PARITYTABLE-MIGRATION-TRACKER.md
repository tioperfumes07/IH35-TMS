...
| `apps/frontend/src/pages/accounting/MultiEntityAccountingPage.tsx` | migrated (verify-step 1150) |
...
| `apps/frontend/src/pages/accounting/journal-entries/JournalEntryDetailPage.tsx` | migrated (verify-step 1159) — display-only; owner-greenlit UI-only migration |

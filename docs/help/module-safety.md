...
> **Content TBD — Jorge fills.** Structured placeholder so the Help center has an entry for the Safety module. Replace each section with real copy (and screenshots).

## Overview
_Content TBD — what the Safety module is for and who uses it._

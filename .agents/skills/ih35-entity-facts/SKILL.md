...
description: >-
  ...
  operating_company_ids, connection details) are NOT here — they live in the local (git-excluded) AGENTS.md.
---
...
local AGENTS.md/secrets, never hard-code them in tracked code.

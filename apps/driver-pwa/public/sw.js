(() => {
  // apps/driver-pwa/src/service-worker.ts
  var CACHE_NAME = "ih35-driver-shell-v2";
  var SHELL_URLS = ["/", "/index.html", "/manifest.json", "/icons/icon-192.png", "/icons/icon-512.png"];
  function parsePushPayload(raw) {
    ...
    if (raw && typeof raw === "object") {
      const obj = raw;
      const data = obj.data && typeof obj.data === "object" && obj.data !== null ? Object.fromEntries(
        Object.entries(obj.data).map(([k, v]) => [k, String(v ?? "")])
      ) : void 0;
      return {
        title: typeof obj.title === "string" ? obj.title : "IH35 Driver",
        body: typeof obj.body === "string" ? obj.body : "",
        tag: typeof obj.tag === "string" ? obj.tag : void 0,
        data
      };
    }

...
export function AngleGuide({ angle, instruction }: Props) {
  ...
  return (
    ...
    >
      <div className="rounded-lg border border-white/40 bg-black/60 px-4 py-3 text-center text-white backdrop-blur-xs">
      ...
      <div className="mt-4 h-32 w-48 rounded-sm border-2 border-dashed border-white/50" aria-hidden />
    </div>
  );
}

    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2">
        <button
          ...
          className={`min-h-11 rounded-lg border px-3 py-2 text-sm ${value.has_report ? "border-hos-offduty_reset text-[#bfdbfe]" : "border-pwa-border text-pwa-text-secondary"}`}
        >
          {labels.has_report}
        </button>
        <button

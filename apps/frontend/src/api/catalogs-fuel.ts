...
export const fuelBrandsCatalogClient = createFuelCatalogClient("brands");
export const fuelStationStatesCatalogClient = createFuelCatalogClient("station-states");
export const fuelPumpTypesCatalogClient = createFuelCatalogClient("pump-types");
export const fuelGradesCatalogClient = createFuelCatalogClient("grades");
export const fuelDispatchRoutesCatalogClient = createFuelCatalogClient("dispatch-routes");

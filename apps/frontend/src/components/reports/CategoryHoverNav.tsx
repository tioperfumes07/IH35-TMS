  ...
  all: [
    {
      id: "trial-balance",
      label: "Trial balance",
      hint: "Debits, credits, and balance check",
    },
    {
      id: "profit-loss",
      label: "Profit & loss",
      hint: "Revenue, COGS, and net income",
    },
    {
      id: "balance-sheet",
      label: "Balance sheet",
      hint: "Assets vs liabilities + equity",
    },
    {
    ...
    },
    {
      ...
      hint: "Liquidity + 30-day projection",
    },
    {
      id: "settlement-summary",
      label: "Settlement summary",
      hint: "Driver pay + deductions",
    },
    {
      id: "customer-profitability",
      label: "Customer profitability",
      hint: "Revenue, cost, margin",
    },
    {
      id: "profit-per-truck",
    ...
    },
    {
      ...
      hint: "Card vs WO (Block V)",
    },
    { id: "maintenance-cost-per-unit", label: "Maintenance cost per unit" },
    {
      id: "geofence-dwell",
      label: "Geofence dwell report",
      hint: "Customer/yard dwell windows",
    },
    {
      id: "scheduled-reports",
      label: "Default subscriptions",
      hint: "Six governed Q8 schedules",
    },
    {
      id: "profit-truck-mtd",
      label: "Profit per truck · MTD",
      hint: "Margin by unit",
    },
    {
      id: "driver-settlement",
      label: "Driver settlement summary",
      hint: "Current cycle",
    },
  ...
  operations: [
    {
      id: "profit-per-truck",
      label: "Profit per truck",
      hint: "Revenue & cost by unit",
    },
    {
      id: "dispatch-board",
      label: "Dispatch board health",
      hint: "Live load movement",
    },
    {
      id: "detention-claims",
      label: "Detention claims",
      hint: "Billed vs collected",
    },
    {
      id: "fuel-reconciliation",
      label: "Fuel reconciliation",
    ...
    },
    {
      ...
      hint: "WO spend by unit",
    },
    {
      id: "geofence-dwell",
      label: "Geofence dwell report",
      hint: "Entry/exit duration by site",
    },
  ],
  financial: [
    {
    ...
    },
    {
      id: "cash-flow-overview",
      label: "Cash flow overview",
      hint: "Operating + DIP + payroll buckets",
    },
    {
      id: "settlement-summary",
      label: "Settlement summary",
      hint: "Driver pay breakdown",
    },
    {
      id: "customer-profitability",
      label: "Customer profitability",
      hint: "Margin by customer",
    },
    {
      id: "cash-position",
      label: "Cash position + AR",
      hint: "Daily liquidity",
    },

...
export function SettlementProfitabilityCard({ loadId }: Props) {
  return (
    <div className="rounded-sm border border-dashed border-emerald-200 bg-emerald-50 p-3 text-sm text-emerald-900" data-testid="drawer-profitability-card-stub">

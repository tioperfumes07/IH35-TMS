...
export function LoadDetailDrawer({ loadId, isOpen, canEdit, onClose }: Props) {
  ...
  const hasPackageMeta = Boolean(
    packageState.meta.generated_at || packageState.meta.emailed_at || packageState.meta.uploaded_at || packageState.meta.invoice_id
  );
                        ...
                        onClick={async () => {
                          ...
                          await updateMutation.mutateAsync({
                            ...
                            body: {
                              ...
                              notes: hasPackageMeta
                                ? serializeFactoringPackageNotes(
                                    {
                                      generated_at: packageState.meta.generated_at,
                                      emailed_at: packageState.meta.emailed_at,
                                      uploaded_at: packageState.meta.uploaded_at,
                                      invoice_id: packageState.meta.invoice_id,
                                    },
                                    notesDraft
                                  )
                                : notesDraft || null,
          ...
          <div className="flex gap-2">
            <Button
              ...
              onClick={() => {
                ...
                setNotesDraft(packageState.visibleNotes ?? "");

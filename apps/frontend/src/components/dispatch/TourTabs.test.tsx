...
const readout: TourReadout = {
  ...
  legs: [{ load_id: "l1", load_number: "13526", trip_type: "NB", status: "dispatched", is_delivered: false, lane: "Uhrichsville OH → Mesquite TX", pickup_city: "Uhrichsville", delivery_city: "Mesquite", revenue_cents: 350000, costs_cents: 148231, driver_pay_cents: 95869, margin_cents: 105900, margin_pct: 30.3, miles_practical: 1610, miles_shortest: null, miles_deadhead: 487.9, miles_real: null, pod_count: 0, cost_count: 5, is_this_load: true }],

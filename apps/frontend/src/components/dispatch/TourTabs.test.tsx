...
const readout: TourReadout = {
  tour: { settlement_id: "3c81e7d5-0000-0000-0000-000000000000", display_id: "S-13646", settlement_number: null, status: "open", approval_status: null, settlement_model: "load_bookended", tour_id: "e3e6ea55-0000-0000-0000-000000000000", driver_id: "d1", driver_name: "LUIS ARMANDO SOSA PEREZ", unit_number: "T170", trip_started_at: "2026-08-17", trip_closed_at: null, period_start: "2026-08-17", period_end: "2026-08-17", is_open: true, locked_at: null, paid_at: null },
  legs: [{ load_id: "l1", load_number: "13526", trip_type: "NB", status: "dispatched", is_delivered: false, lane: "Uhrichsville OH → Mesquite TX", pickup_city: "Uhrichsville", delivery_city: "Mesquite", pickup_date: "2026-08-17", delivery_date: "2026-08-17", revenue_cents: 350000, costs_cents: 148231, driver_pay_cents: 95869, margin_cents: 105900, margin_pct: 30.3, miles_practical: 1610, miles_shortest: null, miles_deadhead: 487.9, miles_real: null, pod_count: 0, cost_count: 5, is_this_load: true, unit_id: null, unit_number: "T170", trailer_id: null, trailer_number: null }],
  ...
  costs: [{ id: "e1", kind: "expense", number: "13526", load_id: "l1", load_number: "13526", date: "2026-08-17", vendor_name: "LOVES", category: "5010 Diesel", amount_cents: 76236, posting_status: "posted", has_account: true, has_vendor: true, receipt_count: 0 }],
  ready: [

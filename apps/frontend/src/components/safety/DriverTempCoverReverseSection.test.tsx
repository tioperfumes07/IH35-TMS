...
const listTempAssignments = vi.fn().mockResolvedValue({ assignments: [{ id: "assignment-1", primary_driver_id: "driver-1", cover_driver_id: "driver-2", unit_number: "101", start_date: "2026-08-13", end_date: "2026-08-14" }] });

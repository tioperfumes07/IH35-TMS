  ...
  return (
    <section data-testid="dispatcher-pending-actions-panel" className="rounded border border-slate-200 bg-white">
      ...
      <ul className="space-y-2 p-3 text-sm">
        ...
        <li className="flex items-center justify-between gap-2 rounded border border-blue-200 bg-blue-50 px-3 py-2">
          <div>
            <div className="font-semibold text-blue-900">Message queue</div>
            <div className="text-xs text-blue-900/80">Unread inbound driver/customer message threads.</div>
          </div>
          <div className="text-right">
            <div className="text-lg font-semibold text-blue-900">{incomingMessageQueue}</div>
            <Link to="/drivers" className="text-xs font-medium text-blue-900 underline">
              Open
            </Link>
          </div>
        </li>

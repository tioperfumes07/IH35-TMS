...
export const FORM_INPUT_CLASS = "h-9 w-full rounded-sm border border-gray-300 px-2 text-[13px]";
...
export const FORM_TEXTAREA_CLASS = "w-full rounded-sm border border-gray-300 px-2 py-1.5 text-[13px]";

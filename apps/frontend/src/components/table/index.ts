// GLOBAL-TABLE-CONTROLS — shared, reusable data-grid toolbar (QuickBooks-style).
...
export { useTableController, type SortDir } from "./useTableController";
export { useTablePref, type TablePref } from "./useTablePref";

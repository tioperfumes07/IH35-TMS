      ...
      <div className="space-y-3 text-xs">
        ...
        {isExternal ? (
          <div className="rounded border border-gray-200 p-2">
            <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-slate-600">External Vendor Invoice</div>
          ...
          <div className="rounded border border-gray-200 p-2">
            <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-slate-600">Parts Links (IS/IT)</div>
            <div className="text-gray-600">Linked parts invoices render here from maintenance.parts_invoice_links.</div>
          </div>
        )}

        <div className="rounded border border-gray-200 p-2">
          <div className="mb-1 text-xs font-semibold uppercase tracking-wide text-slate-600">Audit History</div>

  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid gap-2 rounded-sm border border-gray-200 bg-white p-3 md:grid-cols-3">
        ...
        <CatalogListSearchInput value={search} onChange={(v: string) => { setSearch(v); setPage(1); }} placeholder="Search by code or service name" className="h-9 rounded-sm border border-gray-300 px-2 text-sm md:col-span-2" />

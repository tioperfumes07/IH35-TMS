  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid gap-2 rounded-sm border border-gray-200 bg-white p-3 md:grid-cols-3">
        ...
        <CatalogListSearchInput value={search} onChange={(v: string) => { setSearch(v); setPage(1); }} placeholder="Search by code or service name" className="h-9 rounded-sm border border-gray-300 px-2 text-xs md:col-span-2" />
        <SelectCombobox value={appliesTo} onChange={(e) => { setAppliesTo(e.target.value); setPage(1); }} className="h-9 rounded-sm border border-gray-300 px-2 text-xs">
      ...
      <Modal variant="drawer" open={createOpen} onClose={() => setCreateOpen(false)} title="New Maintenance Service">
        <div className="space-y-3">
          <label className="block text-xs font-semibold text-gray-600">Code<input value={createForm.service_code} onChange={(e) => setCreateForm((v) => ({ ...v, service_code: e.target.value.toUpperCase() }))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
          <label className="block text-xs font-semibold text-gray-600">Service Name<input value={createForm.service_name} onChange={(e) => setCreateForm((v) => ({ ...v, service_name: e.target.value }))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
          <label className="block text-xs font-semibold text-gray-600">Category<input value={createForm.service_category} onChange={(e) => setCreateForm((v) => ({ ...v, service_category: e.target.value }))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
          ...
          <div className="grid grid-cols-3 gap-2">
            <label className="block text-xs font-semibold text-gray-600">Miles<input type="number" min="1" value={createForm.interval_miles} onChange={(e) => setCreateForm((v) => ({ ...v, interval_miles: e.target.value }))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
            <label className="block text-xs font-semibold text-gray-600">Months<input type="number" min="1" value={createForm.interval_months} onChange={(e) => setCreateForm((v) => ({ ...v, interval_months: e.target.value }))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
            <label className="block text-xs font-semibold text-gray-600">Hours<input type="number" min="1" value={createForm.interval_hours} onChange={(e) => setCreateForm((v) => ({ ...v, interval_hours: e.target.value }))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
          </div>
          <label className="block text-xs font-semibold text-gray-600">Typical Duration (hours)<input type="number" min="0" step="0.1" value={createForm.typical_duration_hours} onChange={(e) => setCreateForm((v) => ({ ...v, typical_duration_hours: e.target.value }))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
          ...
          <label className="block text-xs font-semibold text-gray-600">Compliance Reference<input value={createForm.compliance_ref} onChange={(e) => setCreateForm((v) => ({ ...v, compliance_ref: e.target.value }))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
      ...
      <Modal variant="drawer" open={editingId !== null} onClose={() => setEditingId(null)} title="Edit Maintenance Service">
        {editForm ? (
          <div className="space-y-3">
            <label className="block text-xs font-semibold text-gray-600">Code<input value={editForm.service_code} onChange={(e) => setEditForm((v) => (v ? { ...v, service_code: e.target.value.toUpperCase() } : v))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
            <label className="block text-xs font-semibold text-gray-600">Service Name<input value={editForm.service_name} onChange={(e) => setEditForm((v) => (v ? { ...v, service_name: e.target.value } : v))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
            <label className="block text-xs font-semibold text-gray-600">Category<input value={editForm.service_category} onChange={(e) => setEditForm((v) => (v ? { ...v, service_category: e.target.value } : v))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
            ...
            <div className="grid grid-cols-3 gap-2">
              <label className="block text-xs font-semibold text-gray-600">Miles<input type="number" min="1" value={editForm.interval_miles} onChange={(e) => setEditForm((v) => (v ? { ...v, interval_miles: e.target.value } : v))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
              <label className="block text-xs font-semibold text-gray-600">Months<input type="number" min="1" value={editForm.interval_months} onChange={(e) => setEditForm((v) => (v ? { ...v, interval_months: e.target.value } : v))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
              <label className="block text-xs font-semibold text-gray-600">Hours<input type="number" min="1" value={editForm.interval_hours} onChange={(e) => setEditForm((v) => (v ? { ...v, interval_hours: e.target.value } : v))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
            </div>
            <label className="block text-xs font-semibold text-gray-600">Typical Duration (hours)<input type="number" min="0" step="0.1" value={editForm.typical_duration_hours} onChange={(e) => setEditForm((v) => (v ? { ...v, typical_duration_hours: e.target.value } : v))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>
            ...
            <label className="block text-xs font-semibold text-gray-600">Compliance Reference<input value={editForm.compliance_ref} onChange={(e) => setEditForm((v) => (v ? { ...v, compliance_ref: e.target.value } : v))} className="mt-1 h-9 w-full rounded-sm border border-gray-300 px-2 text-xs" /></label>

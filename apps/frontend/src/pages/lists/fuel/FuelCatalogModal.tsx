...
export type FuelCatalogClient = {
  create: (operating_company_id: string, body: FuelCatalogCreateBody) => Promise<FuelCatalogRow>;
  update: (id: string, operating_company_id: string, body: FuelCatalogUpdateBody) => Promise<FuelCatalogRow>;
...
export function FuelCatalogModal({ open, operatingCompanyId, displayName, client, mode, row, onClose, onSaved }: Props) {

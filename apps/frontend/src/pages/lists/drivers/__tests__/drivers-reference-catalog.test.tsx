...
describe("Drivers reference catalog pages", () => {
  ...
  for (const catalog of catalogCases) {
    it(`${catalog.key} renders rows and archive toggle`, async () => {
      ...
      const archiveSpy = vi.spyOn(client, "setArchived").mockResolvedValue({
        id: "11111111-1111-4111-8111-111111111111",
        code: "A",
        label: "Active row",
        sort_order: 10,
      ...
      await waitFor(() => expect(archiveSpy).toHaveBeenCalledWith("11111111-1111-4111-8111-111111111111", true));
    });
  }
});

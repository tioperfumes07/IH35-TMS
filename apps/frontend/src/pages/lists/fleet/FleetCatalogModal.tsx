...
import type { FleetCatalogCreateBody, FleetCatalogRow, FleetCatalogUpdateBody } from "../../../api/catalogs-fleet";
import { Button } from "../../../components/Button";
import { Modal } from "../../../components/Modal";

const CODE_REGEX = /^[A-Z][A-Z0-9-]+$/;

export type FleetCatalogClient = {
  create: (operating_company_id: string, body: FleetCatalogCreateBody) => Promise<FleetCatalogRow>;
  update: (id: string, operating_company_id: string, body: FleetCatalogUpdateBody) => Promise<FleetCatalogRow>;

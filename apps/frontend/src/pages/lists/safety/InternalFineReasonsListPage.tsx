  ...
  return (
    <div className={`${PAGE_SHELL_CLASS} space-y-3`}>
      ...
      <div className="grid grid-cols-1 gap-2 rounded border border-gray-200 bg-white p-3 sm:grid-cols-2 lg:grid-cols-3">
        <input value={search} onChange={(event) => setSearch(event.target.value)} placeholder="Search by code or reason name" className="h-9 rounded border border-gray-300 px-2 text-sm sm:col-span-2 lg:col-span-2" />

...
function wrap(ui: React.ReactElement) {
  ...
  // CargoClaimIntakeSurface mounts CreateDriverModal (useNavigate + useToast) unconditionally
  // beside the driver Combobox +Create affordance, so every page in this suite needs both a
  // Router and a ToastProvider in scope.
  return (

/**
 * DEPRECATED — replaced by BookLoadModalV4 in P6-T11171.
 * Preserved per INVARIANT #24 (never remove, always preserve)
 * for rollback. Do not edit. Delete only after MVP launch + 30 days.
 */
...
export function BookLoadModalV3Deprecated({ open, operatingCompanyId, onClose, onCreated }: Props) {
  const auth = useAuth();

...
export function LoadCostsBoardPage() {
  ...
  const columns: Array<ParityColumn<BoardRow>> = [
    ...
    { key: "fuel", label: "Fuel", testId: "col-fuel", sortable: true, className: NUM, sortValue: r => Number(r.fuel_cents), render: r => fmt(Number(r.fuel_cents)) },
    { key: "repairs_maintenance", label: "R&M Exp", testId: "col-repairs-maintenance", sortable: true, className: NUM, sortValue: r => Number(r.repairs_maintenance_cents), render: r => fmt(Number(r.repairs_maintenance_cents)) },
    { key: "other", label: "Other", testId: "col-other", sortable: true, className: NUM, sortValue: r => Number(r.other_cost_cents), render: r => fmt(Number(r.other_cost_cents)) },

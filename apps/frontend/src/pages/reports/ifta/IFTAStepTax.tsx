...
export function IFTAStepTax({ operatingCompanyId, preparationId, quarter, year }: Props) {
  ...
  return (
    <section className="rounded border border-indigo-200 bg-white">
      <div className="border-b border-indigo-200 bg-indigo-50 px-3 py-2">
        <h3 className="text-xs font-semibold uppercase tracking-wide text-indigo-900">Step 3 · Tax owed (Q{quarter} {year})</h3>
        <p className="text-xs text-indigo-800">Per-state IFTA tax using official quarterly rates.</p>
      </div>
      <div className="space-y-2 px-3 py-3 text-xs">
        <button
          type="button"
          className="rounded border border-indigo-400 bg-indigo-100 px-3 py-1.5 font-semibold text-indigo-900 disabled:opacity-50"

...
> = [
  ...
  { key: "scenario.deductions", title: "Deductions", lane: "money", kind: "money", trigger: "fine / damage / advance payback", spec_ref: "settlement blueprint §1" , links: "Separate itemized ledger, running balance per obligation (not negative pay lines); WF-036 ack gate before settlement closes." },
  ...
  { key: "scenario.accident", title: "Full Accident chain", lane: "risk", kind: "risk", trigger: "accident / safety incident", spec_ref: "DIRE-ACCIDENT linkage" , links: "Depth: accident ⇄ driver ⇄ unit ⇄ trailer ⇄ load → claim ⇄ policy → at-fault: driver_liabilities carries full company-funded repair (WF-036 ack) → damage_recovery = contra-expense (never income)." },

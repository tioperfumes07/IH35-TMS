...
const LIST_ROUTES = [
  ...
  row("/lists/accounting/qbo-categories", <QboCategoriesListPage />, /product & service categories/i),
  row("/lists/accounting/items", <ItemsListPage />, /products & services/i),
  ...
  row("/lists/safety/cargo-claim-reasons", <CargoClaimReasonsListPage />, /cargo claim reasons/i),

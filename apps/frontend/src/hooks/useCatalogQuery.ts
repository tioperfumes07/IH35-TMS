...
export const GENERIC_CATALOG_REGISTRY: Record<string, GenericCatalogDefinition> = {
  ...
  "fleet.asset_condition_codes": {
    ...
    columns: [
      ...
      { key: "name", label: "Asset Condition Code", sortable: true, filterable: true },
    ...
    fields: [
      ...
      { key: "name", label: "Asset Condition Code", type: "text", required: true },
  ...
  "fleet.asset_locations": {
    ...
    columns: [
      { key: "code", label: "Code", sortable: true, filterable: true },
      { key: "name", label: "Asset Location", sortable: true, filterable: true },
      { key: "description", label: "Description", sortable: false, filterable: false },
      { key: "sort_order", label: "Sort", sortable: true, filterable: false },
      { key: "is_active", label: "Status", sortable: true, filterable: false },
    ],
    fields: [
      { key: "code", label: "Code", type: "text", required: true, readOnlyOnEdit: true },
      { key: "name", label: "Asset Location", type: "text", required: true },
      { key: "description", label: "Description", type: "text", required: false },
      { key: "sort_order", label: "Sort Order", type: "number", required: false },
    ],
    defaultSort: { column: "sort_order", dir: "asc" },
  ...
  "fleet.asset_statuses": {
    ...
    columns: [
      { key: "code", label: "Code", sortable: true, filterable: true },
      { key: "name", label: "Asset Statuse", sortable: true, filterable: true },
      { key: "description", label: "Description", sortable: false, filterable: false },
      { key: "sort_order", label: "Sort", sortable: true, filterable: false },
      { key: "is_active", label: "Status", sortable: true, filterable: false },
    ],
    fields: [
      { key: "code", label: "Code", type: "text", required: true, readOnlyOnEdit: true },
      { key: "name", label: "Asset Statuse", type: "text", required: true },
      { key: "description", label: "Description", type: "text", required: false },
      { key: "sort_order", label: "Sort Order", type: "number", required: false },
    ],
    defaultSort: { column: "sort_order", dir: "asc" },
  ...
  "fleet.lease_terms": {
    ...
    columns: [
      { key: "code", label: "Code", sortable: true, filterable: true },
      { key: "name", label: "Lease Term", sortable: true, filterable: true },
      { key: "description", label: "Description", sortable: false, filterable: false },
      { key: "sort_order", label: "Sort", sortable: true, filterable: false },
      { key: "is_active", label: "Status", sortable: true, filterable: false },
    ],
    fields: [
      { key: "code", label: "Code", type: "text", required: true, readOnlyOnEdit: true },
      { key: "name", label: "Lease Term", type: "text", required: true },
      { key: "description", label: "Description", type: "text", required: false },
      { key: "sort_order", label: "Sort Order", type: "number", required: false },
    ],
    defaultSort: { column: "sort_order", dir: "asc" },
  ...
  "fleet.tractor_statuses": {
    ...
    columns: [
      { key: "code", label: "Code", sortable: true, filterable: true },
      { key: "name", label: "Tractor Statuse", sortable: true, filterable: true },
      { key: "description", label: "Description", sortable: false, filterable: false },
      { key: "sort_order", label: "Sort", sortable: true, filterable: false },
      { key: "is_active", label: "Status", sortable: true, filterable: false },
    ],
    fields: [
      { key: "code", label: "Code", type: "text", required: true, readOnlyOnEdit: true },
      { key: "name", label: "Tractor Statuse", type: "text", required: true },
      { key: "description", label: "Description", type: "text", required: false },
      { key: "sort_order", label: "Sort Order", type: "number", required: false },
    ],
    defaultSort: { column: "sort_order", dir: "asc" },
  ...
  "fleet.trailer_statuses": {
    ...
    columns: [
      { key: "code", label: "Code", sortable: true, filterable: true },
      { key: "name", label: "Trailer Statuse", sortable: true, filterable: true },
      { key: "description", label: "Description", sortable: false, filterable: false },
      { key: "sort_order", label: "Sort", sortable: true, filterable: false },
      { key: "is_active", label: "Status", sortable: true, filterable: false },
    ],
    fields: [
      { key: "code", label: "Code", type: "text", required: true, readOnlyOnEdit: true },
      { key: "name", label: "Trailer Statuse", type: "text", required: true },
      { key: "description", label: "Description", type: "text", required: false },
      { key: "sort_order", label: "Sort Order", type: "number", required: false },
    ],
    defaultSort: { column: "sort_order", dir: "asc" },
  ...
  "fleet.trailer_types": {
    ...
    columns: [
      { key: "code", label: "Code", sortable: true, filterable: true },
      { key: "name", label: "Trailer Type", sortable: true, filterable: true },
      { key: "description", label: "Description", sortable: false, filterable: false },
      { key: "sort_order", label: "Sort", sortable: true, filterable: false },
      { key: "is_active", label: "Status", sortable: true, filterable: false },
    ],
    fields: [
      { key: "code", label: "Code", type: "text", required: true, readOnlyOnEdit: true },
      { key: "name", label: "Trailer Type", type: "text", required: true },
      { key: "description", label: "Description", type: "text", required: false },
      { key: "sort_order", label: "Sort Order", type: "number", required: false },
    ],
    defaultSort: { column: "sort_order", dir: "asc" },
  ...
  "fleet.unit_ownership_types": {
    ...
    columns: [
      { key: "code", label: "Code", sortable: true, filterable: true },
      { key: "name", label: "Unit Ownership Type", sortable: true, filterable: true },
      { key: "description", label: "Description", sortable: false, filterable: false },
      { key: "sort_order", label: "Sort", sortable: true, filterable: false },
      { key: "is_active", label: "Status", sortable: true, filterable: false },
    ],
    fields: [
      { key: "code", label: "Code", type: "text", required: true, readOnlyOnEdit: true },
      { key: "name", label: "Unit Ownership Type", type: "text", required: true },
      { key: "description", label: "Description", type: "text", required: false },
      { key: "sort_order", label: "Sort Order", type: "number", required: false },
    ],
    defaultSort: { column: "sort_order", dir: "asc" },

-- CLS-FINANCIAL-TABLE-DELETABLE / ACCT-F139 — WORM sweep #2: the four highest-volume financial
...
BEGIN
  FOREACH v_tbl IN ARRAY ARRAY[
    ...
    IF to_regclass(v_tbl) IS NULL THEN
      RAISE NOTICE 'ACCT-F139: % absent — skipping', v_tbl;
      CONTINUE;
    END IF;
    ...
    RAISE NOTICE 'ACCT-F139: % is now WORM (trigger + REVOKE DELETE)', v_tbl;
  END LOOP;
END
$$;

...
> owner-approval merge label.** Claude and all coders (Cursor / Cascade / Devin / Claude Coder) have **FULL Neon
...
> Any older text below referencing owner-approval merge label, "Devin merges on green" as an exclusive role, "owner
